...
### 最近提交
- 5dd683e docs: 添加退出前保存进展指南 (SAVE_BEFORE_EXIT.md)
- 8d39440 chore: 更新子模块引用和 package 配置
- 179482c docs: 更新项目进展 - 添加进展记录脚本和 FTP 部署功能

---
## 🔄 本次更新 (2026-03-08 13:03:03)

**说明**: 添加进展记录脚本和 FTP 部署功能
...
### 最近提交
- 06c6694 feat: 添加项目进展自动记录脚本 (save-progress.js)
- 594302b docs: 添加项目进展记录 (PROJECT_PROGRESS.md)
- 67285b7 feat: 添加 FTP 部署脚本 (deploy-to-ftp.js)
